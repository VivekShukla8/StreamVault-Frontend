        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-transparent bg-gradient-to-r from-slate-200 via-slate-100 to-slate-300 bg-clip-text">
                Messages
              </h1>
            </div>
          </div>
          ...
          <div className="h-full flex">
            ...
            <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-950/50 to-gray-900/30 backdrop-blur-sm">
              <div className="text-center p-8">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-xl border border-gray-700/50 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg hover:shadow-blue-600/20 transition-all duration-300">
                  <svg
