          ...
          <div className="relative flex-shrink-0 group/thumbnail">
            <div className="aspect-video relative w-full overflow-hidden rounded-t-xl">
              <img
                src={video.thumbnail}
                alt={video.title}
                className="w-full h-full object-contain rounded-t-xl transition-all duration-700 group-hover/thumbnail:scale-110 group-hover/thumbnail:brightness-110 bg-slate-950"
                loading="lazy"
                draggable={false}
              />
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/thumbnail:opacity-100 transition-all duration-400 bg-gradient-to-br from-black/60 via-black/50 to-transparent rounded-t-xl">
                <div className="w-20 h-20 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-2xl shadow-cyan-500/50 hover:shadow-cyan-400/70 cursor-pointer transform scale-90 group-hover/thumbnail:scale-110 transition-all duration-400 ease-out hover:rotate-6">
                  <svg className="w-9 h-9 text-white drop-shadow-2xl ml-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="absolute bottom-3 right-3 z-10">
                <div className="px-3 py-1.5 bg-black/80 backdrop-blur-sm text-cyan-300 text-xs font-bold rounded-lg shadow-xl border border-cyan-500/30 select-none">
              ...
              {video.isLive && (
                <div className="absolute top-3 right-3 z-10">
                  <div className="px-3 py-1.5 bg-gradient-to-r from-red-600 to-red-500 text-white text-xs font-bold rounded-lg flex items-center gap-2 shadow-2xl shadow-red-500/50 select-none">
            ...
            <div className="flex items-start gap-4">
              ...
              >
                <div className="w-12 h-12 rounded-full overflow-hidden bg-slate-900 flex items-center justify-center">
                  ...
                  <span
                    className="text-lg font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-cyan-400 to-purple-500 hidden items-center justify-center w-full h-full select-none"
                  >
              ...
              <div className="flex-1 min-w-0 space-y-2.5">
                {/* Title */}
                <h3 className="font-bold text-lg leading-tight line-clamp-2 text-slate-100 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:via-blue-400 group-hover:to-purple-500 transition-all duration-500 cursor-pointer select-text">
                ...
                <div className="text-sm text-slate-400">
                  <Link
                    to={`/channel/${channelId}`}
                    className="hover:text-cyan-400 transition-colors duration-300 font-medium select-text inline-flex items-center gap-1.5 group/channel"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <span>{channelName}</span>
                    <svg className="w-3.5 h-3.5 opacity-0 group-hover/channel:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs font-medium select-none">
                  {/* Views */}
                  <div className="flex items-center gap-1.5 text-slate-400 hover:text-cyan-400 transition-colors duration-300 group/stat">
                    <svg className="w-4 h-4 group-hover/stat:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Likes */}
                  <div className="flex items-center gap-1.5 text-slate-400 hover:text-blue-400 transition-colors duration-300 group/stat">
                    <svg className="w-4 h-4 group-hover/stat:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Comments */}
                  <div className="flex items-center gap-1.5 text-slate-400 hover:text-purple-400 transition-colors duration-300 group/stat">
                    <svg className="w-4 h-4 group-hover/stat:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* Time */}
                  <div className="flex items-center gap-1.5 text-slate-500 group/stat">
                    <svg className="w-4 h-4 group-hover/stat:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
              ...
              <ShareButton
                ...
                size="small"
                variant="ghost"
                className="opacity-0 group-hover:opacity-100 transition-all duration-400 transform translate-y-2 group-hover:translate-y-0 mt-1 text-slate-500 hover:text-cyan-400 hover:scale-110"
